...
class EditBreeder extends EditRecord
{
    ...
    // KĽÚČOVÁ ZMENA 1: Verejná vlastnosť na uloženie čísla stránky
    // Musí byť deklarovaná, aby Livewire fungoval.
    public ?string $page = null;
    ...
    protected function getRedirectUrl(): string
    {
        // Používame priamo $this->page, ktorý bol spoľahlivo uložený vďaka $queryString
        if ($this->page) {
            // Presmeruje späť na stranu s uloženým číslom
            return $this->getResource()::getUrl('index', [
                'page' => $this->page,
        ...
        // Ak parameter neexistuje (napr. bol na strane 1), vráťte sa na index
        return $this->getResource()::getUrl('index');
    }
}
...
namespace App\Filament\Resources\Breeders\Pages;
#namespace App\Filament\Resources\BreederResource\Pages;
